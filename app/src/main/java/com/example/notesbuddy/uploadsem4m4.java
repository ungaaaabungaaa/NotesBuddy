...
public class uploadsem4m4 extends AppCompatActivity implements BSImagePicker.OnSingleImageSelectedListener,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_uploadsem4m4);
        ...
        uStorageRef = FirebaseStorage.getInstance().getReference("sem4m4");
        uDatabaseRef = FirebaseDatabase.getInstance().getReference( "sem4m4");
        ...
        uButtonUpload.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (uUploadTask != null && uUploadTask.isInProgress()) {
                    Toast.makeText(uploadsem4m4.this, "Upload in progress", Toast.LENGTH_SHORT).show();
                } else {
                    uploadFile();
                }
            }
        ...
        mDatabaseRef = FirebaseDatabase.getInstance().getReference("sem4m4");
        ...
        mDBListener = mDatabaseRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                mAdapter = new ImageAdapter(uploadsem4m4.this, mUploads);
                mAdapter.setOnItemClickListener(uploadsem4m4.this);
                RecyclerView.setAdapter(mAdapter);
            }

            @Override
            public void onCancelled(@NonNull DatabaseError databaseError) {
                Toast.makeText(uploadsem4m4.this, databaseError.getMessage(), Toast.LENGTH_SHORT).show();
            }
        });
            ...
            uUploadTask = fileReference.putFile(compreeseduri)
                    .addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                        ...
                        public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                            ...
                            Toast.makeText(uploadsem4m4.this, "Upload successful", Toast.LENGTH_LONG).show();
                            uProgressBar.setVisibility(View.INVISIBLE);
                            file.delete();
                        }
                    })
                    .addOnFailureListener(new OnFailureListener() {
                        ...
                        public void onFailure(@NonNull Exception e) {
                            Toast.makeText(uploadsem4m4.this, e.getMessage(), Toast.LENGTH_SHORT).show();
                            uProgressBar.setVisibility(View.INVISIBLE);
                            file.delete();
                        }
                    })
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == CropImage.CROP_IMAGE_ACTIVITY_REQUEST_CODE) {
            ...
            {
                file.delete();
                Toast toast = Toast.makeText(uploadsem4m4.this, "No Image selected", Toast.LENGTH_LONG); toast.show();
            }
            if (resultCode == CropImage.CROP_IMAGE_ACTIVITY_RESULT_ERROR_CODE) {
                Exception error = result.getError();
                Toast.makeText(uploadsem4m4.this, "Error : " + error, Toast.LENGTH_LONG).show();
                file.delete();
            }
        }
    }
    ...
    public void onItemClick(String position) {
        Intent intent =new Intent(uploadsem4m4.this,zoomimage.class);
    ...
    public void onDeleteClick(int position) {
        ...
        imageRef.delete().addOnSuccessListener(new OnSuccessListener<Void>() {
            ...
            public void onSuccess(Void aVoid) {
                ...
                Toast.makeText(uploadsem4m4.this, "Item deleted", Toast.LENGTH_SHORT).show();
            }
        });
    }
}
